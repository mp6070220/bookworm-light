...
./ngrok authtoken 1oZanIisSMcPhpJEWnsEWKqT4kp_3v6jQ8ftysQk9RD8N2M2Q
...
wget -O virtio-win.iso 'https://x.gtlo.workers.dev/0:/virtio-win-0.1.215.iso'
wget -O windows7nano.iso 'https://x.gtlo.workers.dev/0:/Windows%207.iso'
